...
public class Kolore_historiala_controller {
    ...
    @GetMapping("")
    @Operation(
    	    summary = "Kolore historial guztia lortzea",
    	    description = "Kolore historial guztiak itzultzen ditu.",
    	    responses = {
    ...
    @GetMapping("/id/{id}")
    @Operation(
    	    summary = "Kolore historial bat lortzea IDaren arabera",
    	    description = "Kolore historial bat bilatzen du IDarekin eta aurkitzen bada itzultzen du.",
    	    responses = {
    ...
    @PostMapping("")
    @Operation(
    	    summary = "Kolore historial berri bat sortzea",
    	    description = "Kolore historial berri bat sortzen du emandako datuekin.",
    	    responses = {
