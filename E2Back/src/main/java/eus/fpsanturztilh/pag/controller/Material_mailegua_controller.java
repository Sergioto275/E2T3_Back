...
public class Material_mailegua_controller {
    ...
    @GetMapping("")
    @Operation(
    	    summary = "Material Mailegua guztiak lortzea",
    	    description = "Material Mailegua guztiak itzultzen ditu.",
    	    responses = {
    ...
    @GetMapping("/id/{id}")
    @Operation(
    	    summary = "Material Mailegua bat lortzea IDaren arabera",
    	    description = "Material Mailegua bat bilatzen du IDarekin eta aurkitzen bada itzultzen du.",
    	    responses = {
    ...
    @PutMapping("")
    @Operation(
    	    summary = "Mugimenduak bukatzea",
    	    description = "Material Maileguen mugimenduak amaitzen ditu.",
    	    responses = {
	...
	@PostMapping("")
	@Operation(
		    summary = "Mugimenduak erregistratzea",
		    description = "Material Maileguen mugimenduak erregistratzen ditu.",
		    responses = {
